...
;V is a word array of length 2·n.
;Even index: Tmin.
;Odd index: Tmax.
;Escursione = Tmax − Tmin.

;Procedure must compute:
;maximum escursione
;average escursione (integer division)
...
section .bss
W resw 2 ;W è il vettore delle escursioni termiche delle città (Tmax(2n-1)-Tmin(2n))
